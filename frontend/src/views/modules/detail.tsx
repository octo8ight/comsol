        ...
        <div>
            <div className="pt-6">
                ...
                <div className="mx-auto mt-6 max-w-2xl sm:px-6">
                    {detail.data.imgPath !== "" && <Image src={API_URL + detail.data.imgPath} alt="module 1" width={640} height={450} className="h-full w-full object-cover object-center rounded-3xl" />}
                </div>
